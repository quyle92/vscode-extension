...
* Temporarily rolled back package updates to be the same as 2.11.0 since some kind of memory error seams to have appeared with custom patterns (issue [#286](https://github.com/emilast/vscode-logfile-highlighter/issues/286)).
